import { AnimatedNumber } from '@/components/landing-page/animated-number';
      ...
      <section className="mt-16 grid grid-cols-1 lg:grid-cols-2 lg:gap-12">
        <div className="max-w-lg">
          ...
          <p className="mt-6 text-sm/6 text-gray-600">
            At Agentive, we are dedicated to transforming the way revenue organizations source and
...
function Team() {
  return (
    <Container className="mt-32">
      ...
      <Lead className="mt-6 max-w-3xl">
        Agentive is founded by two of the best sellers in the business and backed by investors who
        look the other way.
      </Lead>
      <div className="mt-12 grid grid-cols-1 gap-12 lg:grid-cols-2">
        <div className="max-w-lg">
          <p className="text-sm/6 text-gray-600">
            ...
            incredible success, and that idea became the kernel for Agentive.
          </p>
          <p className="mt-8 text-sm/6 text-gray-600">
            Today, Agentive transforms revenue organizations by harnessing illegally acquired
            customer and competitor data, using it to provide extraordinary leverage. More than
            30,000 companies rely on Agentive to undercut their competitors and extort their
